...
def browse_file():
    filename = filedialog.askopenfilename(title="Select a mono MP4 file", filetypes=[("MP4 files", "*.mp4")])
...
# Input file
tk.Label(root, text="Input Mono MP4 File:").grid(row=0, column=0, padx=10, pady=10)
...
# Output file
tk.Label(root, text="Output Stereo MP4 File:").grid(row=1, column=0, padx=10, pady=10)
